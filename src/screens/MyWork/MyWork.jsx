...
function MyWork() {
    ...
    const usageTrackingSystemRef = useRef();
    const muxableRef = useRef();
    const openfamRef = useRef();
    const buzzwomanRef = useRef();
    ...
    useEffect(() => {
            ...
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
                    entry.target.classList.forEach((value) => {
                        value === 'usageTrackingSystemRef' && usageTrackingSystemRef.current.classList.add('fancify-work')
                        value === 'muxableRef' && muxableRef.current.classList.add('fancify-work')
                        value === 'buzzwomanRef' && buzzwomanRef.current.classList.add('fancify-work')
                        value === 'openfamRef' && openfamRef.current.classList.add('fancify-work')
        ...
        observer.observe(usageTrackingSystemRef.current)
        observer.observe(muxableRef.current)
        observer.observe(buzzwomanRef.current)
        observer.observe(openfamRef.current)
        observer.observe(streamrRef.current)
    }, [])
    ...
    return (
        <div id='work' className="work-section">
            <section className="work-container">
                ...
                <p className="work-description usageTrackingSystemRef" ref={usageTrackingSystemRef}>
                ...
                <p className="work-description muxableRef" ref={muxableRef}>
                ...
                <p className="work-description buzzwomanRef" ref={buzzwomanRef}>
                ...
                <p className="work-description openfamRef" ref={openfamRef}>
                ...
                <p className="work-description streamrRef" ref={streamrRef}>
