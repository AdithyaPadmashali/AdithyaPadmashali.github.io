        ...
        <div id='work' className="work-section">
            <section className="work-container">
                ...
                <WorkItem
                    ...
                    titleDecorator={['< ', ' />']}
                    refName={'usageTrackingSystemRef'}
                    content={<>
                ...
                <WorkItem
                    title={<>Chat-bot for <a href='https://www.buzzwomen.org/' target='blank'><span className='click-for-details'>Buzzwomen</span></a></>}
                    titleDecorator={['< ', ' >']}
                    refName={'buzzwomanRef'}
                    content={<>
                ...
                <WorkItem
                    title={'Python OpenFAM API'}
                    titleDecorator={['__', ' __']}
                    refName={'openfamRef'}
                    content={<>
                ...
                <WorkItem
                    title={<><a href='https://streamr.network' target='blank'><span className='click-for-details'>Streamr</span></a> Data Challenge</>}
                    titleDecorator={['${ ', ' }']}
                    refName={'streamrRef'}
                    content={<>
